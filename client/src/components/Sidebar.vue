        ...
        <ul class="nav-list">
          ...
          <li class="nav-item">
            <router-link 
              to="/ssh-logs" 
              class="nav-link"
              :class="{ 'active': $route.name === 'ssh-logs' }"
            >
              <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="nav-item">
            <router-link 
              to="/ssh-analytics" 
              class="nav-link"
              :class="{ 'active': $route.name === 'ssh-analytics' }"
            >
              <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="nav-item">
            <router-link 
              to="/ufw-logs" 
              class="nav-link"
              :class="{ 'active': $route.name === 'ufw-logs' }"
            >
              <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="nav-item">
            <router-link 
              to="/ufw-analytics" 
              class="nav-link"
              :class="{ 'active': $route.name === 'ufw-analytics' }"
            >
              <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
...
const isAdmin = computed(() => 
  props.currentUser?.accountType === 'admin' || 
  props.currentUser?.accountType === 'superadmin'
)
</script>
